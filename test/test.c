...
void test_add(void) {
  ...
  CU_ASSERT_DOUBLE_EQUAL(add(-1.1, -2.2), -3.3, .001);
}

/* Story 7: As a user, I want to be able to subtract two numbers using the
 * program, so I can use it for subtraction
 */
...
/* Story 8: As a user, I want to be able to multiply two numbers using the
 * program, so I can use it for multiplciation
 */
...
/* Story 9: As a user, I want to be able to divide two numbers using the
 * program, so I can use it for division
 */
